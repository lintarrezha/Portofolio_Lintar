...
export default function Header() {
  ...
  return (
    <header className="z-[1] md:z-[999] relative">
      ...
      <motion.div
        className="hidden md:block fixed top-0 left-1/2 h-[4.5rem] w-[calc(100%+8rem)] rounded-none border border-white border-opacity-40 bg-white bg-opacity-50 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[calc(36rem+8rem)] sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-40"
